...
<body>
  <form class="form-group shadow p-3 mb-5 rounded" style="background-color: #eeeeee;"  method="post" action="">
    <fieldset class="border p-2">
      ...
      <!-- Dirección de la empresa , texto, obligatorio -->
      <div class="row align-items-start">
        <div class="mb-3 col-md-6">
          <label for="direccion_emp" class="form-label">Dirección</label> <!-- <label for="direccion_emp" class="form-label">@lang('datosempresa.dir_postal')</label> -->
